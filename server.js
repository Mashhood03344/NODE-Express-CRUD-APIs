...
// getting the CRUD APIs from the file for the company table
const companyRoutes = require('./routes/Company_CRUD_APIs');

// getting the CRUD APIs from the file for the department table
const departmentRoutes = require('./routes/Department_CRUD_APIs');

// getting the CRUD APIs from the file for the company_department table
const companyDepartmentRoutes = require('./routes/Company_Department_CRUD_APIs');

// getting the CRUD APIs from the file for the company_department table
const EmployeeRoutes = require('./routes/Employee_CRUD_APIs');

// Use the company CRUD APIs routes
app.use('/api', companyRoutes);

// Use the department CRUD APIs routes
app.use('/api', departmentRoutes);

// Use the company_department CRUD APIs routes
app.use('/api', companyDepartmentRoutes);

// Use the employee CRUD APIs routes
...
// // GET API
// app.get("/company_department", async (req, res) => {
//     try {
...
// app.put('/updateCompanyDepartment/Company/:id', async (req, res) => {
//     try {
...
// app.put('/updateCompanyDepartment/Department/:id', async (req, res) => {
//     try {
//         const com_dep_id = parseInt(req.params.id);
...
// app.delete('/deleteCompanyDepartment/:id', async (req, res) => {
//     try {
//         const com_dep_id = parseInt(req.params.id);
